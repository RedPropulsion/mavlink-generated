...
#define MAVLINK_REDASTER_XML_HASH -4343096906661705485
...
typedef enum ServosList
{
   ...
   ANTENNA_SERVO_PITCH=3, /* Servo of the antenna tracking system | */
   ANTENNA_SERVO_ROLL=4, /* Servo of the antenna tracking system | */
