...
#define MAVLINK_MSG_ID_ROCKET_STATS_TM_LEN 177
#define MAVLINK_MSG_ID_ROCKET_STATS_TM_MIN_LEN 177
#define MAVLINK_MSG_ID_210_LEN 177
#define MAVLINK_MSG_ID_210_MIN_LEN 177

#define MAVLINK_MSG_ID_ROCKET_STATS_TM_CRC 32
#define MAVLINK_MSG_ID_210_CRC 32
...
#define MAVLINK_MESSAGE_INFO_ROCKET_STATS_TM { \
    ...
    {  { "timestamp", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_rocket_stats_tm_t, timestamp) }, \
         ...
         { "ada_state", NULL, MAVLINK_TYPE_UINT8_T, 0, 162, offsetof(mavlink_rocket_stats_tm_t, ada_state) }, \
         { "abk_state", NULL, MAVLINK_TYPE_UINT8_T, 0, 163, offsetof(mavlink_rocket_stats_tm_t, abk_state) }, \
         { "nas_state", NULL, MAVLINK_TYPE_UINT8_T, 0, 164, offsetof(mavlink_rocket_stats_tm_t, nas_state) }, \
         { "mea_state", NULL, MAVLINK_TYPE_UINT8_T, 0, 165, offsetof(mavlink_rocket_stats_tm_t, mea_state) }, \
         { "exp_angle", NULL, MAVLINK_TYPE_FLOAT, 0, 156, offsetof(mavlink_rocket_stats_tm_t, exp_angle) }, \
         { "pin_launch", NULL, MAVLINK_TYPE_UINT8_T, 0, 166, offsetof(mavlink_rocket_stats_tm_t, pin_launch) }, \
         { "pin_nosecone", NULL, MAVLINK_TYPE_UINT8_T, 0, 167, offsetof(mavlink_rocket_stats_tm_t, pin_nosecone) }, \
         { "pin_expulsion", NULL, MAVLINK_TYPE_UINT8_T, 0, 168, offsetof(mavlink_rocket_stats_tm_t, pin_expulsion) }, \
         { "cutter_presence", NULL, MAVLINK_TYPE_UINT8_T, 0, 169, offsetof(mavlink_rocket_stats_tm_t, cutter_presence) }, \
         { "log_number", NULL, MAVLINK_TYPE_INT16_T, 0, 160, offsetof(mavlink_rocket_stats_tm_t, log_number) }, \
         { "log_good", NULL, MAVLINK_TYPE_UINT8_T, 0, 170, offsetof(mavlink_rocket_stats_tm_t, log_good) }, \
         { "payload_board_state", NULL, MAVLINK_TYPE_UINT8_T, 0, 171, offsetof(mavlink_rocket_stats_tm_t, payload_board_state) }, \
         { "motor_board_state", NULL, MAVLINK_TYPE_UINT8_T, 0, 172, offsetof(mavlink_rocket_stats_tm_t, motor_board_state) }, \
         { "payload_can_status", NULL, MAVLINK_TYPE_UINT8_T, 0, 173, offsetof(mavlink_rocket_stats_tm_t, payload_can_status) }, \
         { "motor_can_status", NULL, MAVLINK_TYPE_UINT8_T, 0, 174, offsetof(mavlink_rocket_stats_tm_t, motor_can_status) }, \
         { "rig_can_status", NULL, MAVLINK_TYPE_UINT8_T, 0, 175, offsetof(mavlink_rocket_stats_tm_t, rig_can_status) }, \
         { "hil_state", NULL, MAVLINK_TYPE_UINT8_T, 0, 176, offsetof(mavlink_rocket_stats_tm_t, hil_state) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_ROCKET_STATS_TM { \
                               ...
                               uint64_t timestamp, uint64_t liftoff_ts, uint64_t liftoff_max_acc_ts, float liftoff_max_acc, uint64_t max_speed_ts, float max_speed, float max_speed_altitude, uint64_t max_mach_ts, float max_mach, uint64_t shutdown_ts, float shutdown_alt, uint64_t apogee_ts, float apogee_lat, float apogee_lon, float apogee_alt, uint64_t apogee_max_acc_ts, float apogee_max_acc, uint64_t dpl_ts, float dpl_alt, uint64_t dpl_max_acc_ts, float dpl_max_acc, uint64_t dpl_bay_max_pressure_ts, float dpl_bay_max_pressure, float ref_lat, float ref_lon, float ref_alt, float cpu_load, uint32_t free_heap, uint8_t ada_state, uint8_t abk_state, uint8_t nas_state, uint8_t mea_state, float exp_angle, uint8_t pin_launch, uint8_t pin_nosecone, uint8_t pin_expulsion, uint8_t cutter_presence, int16_t log_number, uint8_t log_good, uint8_t payload_board_state, uint8_t motor_board_state, uint8_t payload_can_status, uint8_t motor_can_status, uint8_t rig_can_status, uint8_t hil_state)
{
    ...
    _mav_put_int16_t(buf, 160, log_number);
    _mav_put_uint8_t(buf, 162, ada_state);
    ...
    _mav_put_uint8_t(buf, 170, log_good);
    _mav_put_uint8_t(buf, 171, payload_board_state);
    _mav_put_uint8_t(buf, 172, motor_board_state);
    _mav_put_uint8_t(buf, 173, payload_can_status);
    _mav_put_uint8_t(buf, 174, motor_can_status);
    _mav_put_uint8_t(buf, 175, rig_can_status);
    _mav_put_uint8_t(buf, 176, hil_state);
 ...
 */
static inline uint8_t mavlink_msg_rocket_stats_tm_get_log_good(const mavlink_message_t* msg)
{
